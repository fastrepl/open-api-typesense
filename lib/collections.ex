defmodule Typesense.Collections do
  ...
  """
  @spec create_collection(Typesense.CollectionSchema.t(), keyword) ::
  ...
  """
  @spec get_aliases(keyword) :: {:ok, Typesense.CollectionAliasesResponse.t()} | :error
  ...
  """
  @spec get_collections(keyword) :: {:ok, [Typesense.CollectionResponse.t()]} | :error
  ...
  """
  @spec update_collection(String.t(), Typesense.CollectionUpdateSchema.t(), keyword) ::
  ...
  """
  @spec upsert_alias(String.t(), Typesense.CollectionAliasSchema.t(), keyword) ::
          {:ok, Typesense.CollectionAlias.t()} | {:error, Typesense.ApiResponse.t()}
