defmodule Typesense.Documents do
  ...
  """
  @spec delete_documents(String.t(), keyword) :: {:ok, map} | {:error, Typesense.ApiResponse.t()}
  ...
  """
  @spec multi_search(Typesense.MultiSearchSearchesParameter.t(), keyword) ::
  ...
  """
  @spec upsert_search_synonym(String.t(), String.t(), Typesense.SearchSynonymSchema.t(), keyword) ::
          {:ok, Typesense.SearchSynonym.t()} | {:error, Typesense.ApiResponse.t()}
