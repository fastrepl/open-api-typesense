defmodule Typesense.Operations do
  ...
  """
  @spec retrieve_api_stats(keyword) :: {:ok, Typesense.APIStatsResponse.t()} | :error
  def retrieve_api_stats(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Typesense.Operations, :retrieve_api_stats},
      url: "/stats.json",
      method: :get,
      response: [{200, {Typesense.APIStatsResponse, :t}}],
      opts: opts
    })
  end
  ...
  def retrieve_metrics(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Typesense.Operations, :retrieve_metrics},
      url: "/metrics.json",
      method: :get,
      response: [{200, :map}],
      opts: opts
  ...
  """
  @spec take_snapshot(keyword) :: {:ok, Typesense.SuccessStatus.t()} | :error
  ...
  """
  @spec vote(keyword) :: {:ok, Typesense.SuccessStatus.t()} | :error
  def vote(opts \\ []) do
    client = opts[:client] || @default_client
